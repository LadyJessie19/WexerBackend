...
function getOneUser(id, repository) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!user) {
                return (0, ErrorHandler_1.default)(`The psychologist with the id ${id} wasn't found.`, 404, "!user");
            }
            return (0, SuccessHandler_1.default)("Psychologist successfully found.", 200, user);
        }
        catch (error) {
