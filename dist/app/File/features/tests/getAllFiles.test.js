...
const getAllFiles_service_1 = __importDefault(require("./../getAllFiles.service"));
...
test('should return a files object with paginated data', () => __awaiter(void 0, void 0, void 0, function* () {
    const page = 1;
    const limit = 2;
    jest.spyOn(repository, 'getAllRep').mockResolvedValue(mock);
    const result = yield (0, getAllFiles_service_1.default)(page, limit, repository);
