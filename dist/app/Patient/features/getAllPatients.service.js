...
function getAllPatients(page, limit, repository) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { message, statusCode, pageInfo, result } = yield (0, PaginateData_1.default)(page, limit, 'patient', repository);
            const payload = { pageInfo, result };
            return (0, SuccessHandler_1.default)(message, statusCode, payload);
        }
        catch (error) {
            return (0, ServerError_1.default)(error, "getAllPatients catch");
        }
    });
}
