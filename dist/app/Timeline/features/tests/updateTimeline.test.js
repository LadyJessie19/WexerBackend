...
const updateTimeline_service_1 = __importDefault(require("../updateTimeline.service"));
const repository = TimelineModule_1.default.build().repository;
const id = "yN9HjL3oXxR7gFtDcVbAqW2e";
test('should update the Timeline by the id', () => __awaiter(void 0, void 0, void 0, function* () {
    const mock = {
        _id: '',
        name: '',
        nickname: '',
    ...
    const result = yield (0, updateTimeline_service_1.default)(id, body, repository);
