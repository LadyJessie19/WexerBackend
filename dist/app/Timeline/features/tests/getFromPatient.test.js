...
const getFromPatient_service_1 = __importDefault(require("../getFromPatient.service"));
...
test('should return the timelines from the choosen id', () => __awaiter(void 0, void 0, void 0, function* () {
    const page = 1;
    const limit = 2;
    jest.spyOn(repository, 'getFromParentRep').mockResolvedValue(mock);
    const result = yield (0, getFromPatient_service_1.default)(id, page, limit, repository);
