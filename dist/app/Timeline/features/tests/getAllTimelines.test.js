...
const getAllTimelines_service_1 = __importDefault(require("./../getAllTimelines.service"));
...
test('should return a timelines object with paginated data', () => __awaiter(void 0, void 0, void 0, function* () {
    const page = 1;
    const limit = 2;
    jest.spyOn(repository, 'getAllRep').mockResolvedValue(mock);
    const result = yield (0, getAllTimelines_service_1.default)(page, limit, repository);
