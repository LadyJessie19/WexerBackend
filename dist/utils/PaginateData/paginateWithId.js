 ...
 */
function paginateWithId(findId, skip, limit, repository) {
    return __awaiter(this, void 0, void 0, function* () {
        const { totalItems, result } = yield repository.getFromParentRep(findId, skip, limit);
        return { totalItems, result };
    });
}
exports.default = paginateWithId;
